--- 
sidebar_label: 'Js SDK 接入指南'
slug: /xuperos/xuperos_js 
sidebar_position: 6
---
...
JS SDK 连接开放网络与 Go SDK 有些许不同之处，主要在配置文件，JS SDK
不需要配置文件，只需要在创建客户端时指定参数即可。
...
具体接口文档参考 [JS SDK
使用文档](../development_manuals/xuper-sdk/xuper-sdk-js.html) 。
